...
public class IncomeControoler {
	...
	// Attribute
		...
		public List<Income> getIncomesByDescription(@RequestParam("incomeDescription") IncomeDescription incomeDescription) throws ApplicationException {
			return incomeService.getIncomesByDescription(incomeDescription);
		}
		
		@GetMapping("/byCompany")
		public List<Income> getIncomesByCompany(@RequestParam("companyID") long companyID) throws ApplicationException {
			return incomeService.getIncomesByCompany(companyID);
		}
